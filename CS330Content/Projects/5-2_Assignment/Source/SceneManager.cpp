...
void SceneManager::LoadSceneTextures()
{
	...
	if (!CreateGLTexture("./Utilities/textures/pavers.jpg", "floor"))
		std::cout << "Failed: floor\n";

	if (!CreateGLTexture("./Utilities/textures/gold-seamless-texture.jpg", "cylinder"))
		std::cout << "Failed: cylinder\n";

	if (!CreateGLTexture("./Utilities/textures/rusticwood.jpg", "plank"))
		std::cout << "Failed: plank\n";

	if (!CreateGLTexture("./Utilities/textures/tilesf2.jpg", "box"))
		std::cout << "Failed: box\n";

	if (!CreateGLTexture("./Utilities/textures/stainedglass.jpg", "ball"))
		std::cout << "Failed: ball\n";

	if (!CreateGLTexture("./Utilities/textures/abstract.jpg", "cone"))
		std::cout << "Failed: cone\n";
