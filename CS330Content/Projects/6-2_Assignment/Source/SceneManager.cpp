...
void SceneManager::DefineObjectMaterials()
{
	...
	goldMaterial.ambientColor = glm::vec3(0.5f, 0.1f, 0.3f);
	goldMaterial.diffuseColor = glm::vec3(0.7f, 0.2f, 0.5f);
	goldMaterial.specularColor = glm::vec3(1.0f, 0.4f, 0.7f);
	...
	cementMaterial.ambientColor = glm::vec3(0.3f, 0.1f, 0.2f);
	cementMaterial.diffuseColor = glm::vec3(0.6f, 0.3f, 0.5f);
	cementMaterial.specularColor = glm::vec3(0.8f, 0.4f, 0.6f);
	...
	woodMaterial.ambientColor = glm::vec3(0.4f, 0.1f, 0.3f);
	woodMaterial.diffuseColor = glm::vec3(0.6f, 0.2f, 0.4f);
	woodMaterial.specularColor = glm::vec3(0.7f, 0.3f, 0.5f);
	...
	tileMaterial.ambientColor = glm::vec3(0.4f, 0.1f, 0.4f);
	tileMaterial.diffuseColor = glm::vec3(0.7f, 0.2f, 0.5f);
	tileMaterial.specularColor = glm::vec3(0.9f, 0.4f, 0.7f);
	...
	glassMaterial.ambientColor = glm::vec3(0.5f, 0.2f, 0.5f);
	glassMaterial.diffuseColor = glm::vec3(0.7f, 0.3f, 0.6f);
	glassMaterial.specularColor = glm::vec3(1.0f, 0.5f, 0.8f);
	...
	clayMaterial.ambientColor = glm::vec3(0.3f, 0.1f, 0.3f);
	clayMaterial.diffuseColor = glm::vec3(0.6f, 0.2f, 0.5f);
	clayMaterial.specularColor = glm::vec3(0.8f, 0.3f, 0.6f);
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.2f, 0.05f, 0.1f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.9f, 0.3f, 0.6f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.2f, 0.05f, 0.1f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.9f, 0.3f, 0.6f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", 0.2f, 0.05f, 0.1f);
	m_pShaderManager->setVec3Value("lightSources[2].diffuseColor", 0.8f, 0.2f, 0.5f);
	m_pShaderManager->setVec3Value("lightSources[2].specularColor", 1.0f, 0.4f, 0.7f);
